...
VALID_INPUT_TYPES = {
    "text/free", "text/number", "text/email", "text/date", "text/links",
...
def dataset_form_add_and_edit():
    ...
    return render_template("dataset_form_add_and_edit.html", dataset_type=dataset_type, sheet_id=sheet_id, corporate_id=corporate_id)
...
@app.route('/dataset_data_input/<dataset_type>/<int:entity_id>/<string:input_code>')
def dataset_data_input(dataset_type, entity_id, input_code=None):
    if dataset_type == "compliance":
        return render_template("dataset_data_input.html", dataset_type=dataset_type, sheet_id=entity_id, input_code=input_code)
    elif dataset_type == "corporate":
        return render_template("dataset_data_input.html", dataset_type=dataset_type, corporate_id=entity_id, input_code=input_code)
